...
print("Would you like to control the camera by Meditation (1), Attention (2), or Alpha Wave Levels (3)? ")
control_desired = int(raw_input("> "))
print("Input threshold vlaue. (Recommended 80 for Att or Med, 0.4 for Alpha)")
